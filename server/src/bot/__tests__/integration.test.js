...
// ============================================================
describe('项目创建 — 确认与取消', () => {
  const fullParams = { name: '测试', category: '设备', owner: '张三', department: 'FBU', budget: 100, planStart: '2026-01-01', planEnd: '2026-12-31', isSingleSource: '否', budgetAmount: '<100万', procurementMethod: '项目类' }
...
describe('卡片按钮操作', () => {
  test('确认创建项目 → 调用 create_project', async () => {
    ...
    const action = {
      ...
      params: { name: '测试', category: '设备', owner: '张三', department: 'FBU', budget: 100, planStart: '2026-01-01', planEnd: '2026-12-31', isSingleSource: '否', budgetAmount: '<100万', procurementMethod: '项目类' },
    }
