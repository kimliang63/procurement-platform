...
describe('项目创建 — 发起创建', () => {
  ...
  test('信息完整 → 发送确认卡片', async () => {
    understandIntent.mockResolvedValue({
      intent: 'create_project',
      params: { name: '测试项目', category: '设备', owner: '张三', department: 'FBU', budget: 100, planStart: '2026-01-01', planEnd: '2026-12-31', isSingleSource: '否', procurementMethod: '项目类' },
      message: '请确认以下信息',
    })
  ...
  test('全部信息一次性输入 → 发送确认卡片', async () => {
    understandIntent.mockResolvedValue({
      intent: 'create_project',
      params: { name: '测试项目', category: '设备', owner: '张三', department: 'FBU', budget: 200, planStart: '2026-03-01', planEnd: '2026-12-31', isSingleSource: '否', procurementMethod: '项目类' },
      message: '请确认',
    })
...
describe('项目创建 — 日期校验', () => {
  test('结束早于开始 → 报错', async () => {
    understandIntent.mockResolvedValue({
      intent: 'create_project',
      params: { name: '测试', category: '设备', department: 'FBU', budget: 100, planStart: '2026-12-31', planEnd: '2026-01-01', isSingleSource: '否', procurementMethod: '项目类' },
      message: '请确认',
    })
  ...
  test('同一天 → 允许通过', async () => {
    understandIntent.mockResolvedValue({
      intent: 'create_project',
      params: { name: '测试', category: '设备', department: 'FBU', budget: 100, planStart: '2026-06-01', planEnd: '2026-06-01', isSingleSource: '否', procurementMethod: '项目类' },
      message: '请确认',
    })
...
// ============================================================
describe('项目创建 — 确认与取消', () => {
  const fullParams = { name: '测试', category: '设备', owner: '张三', department: 'FBU', budget: 100, planStart: '2026-01-01', planEnd: '2026-12-31', isSingleSource: '否', procurementMethod: '项目类' }
...
describe('卡片按钮操作', () => {
  test('确认创建项目 → 调用 create_project', async () => {
    ...
    const action = {
      ...
      params: { name: '测试', category: '设备', owner: '张三', department: 'FBU', budget: 100, planStart: '2026-01-01', planEnd: '2026-12-31', isSingleSource: '否', procurementMethod: '项目类' },
    }
